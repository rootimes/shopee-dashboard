...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->dateTime('ordered_at')->nullable()->index()->comment('訂單成立時間');
            $table->unsignedInteger('total_price')->nullable()->comment('商品總價');
            $table->unsignedInteger('buyer_shipping_fee')->nullable()->comment('買家運費');
            ...
            $table->unsignedInteger('shopee_coin_deduction')->nullable()->comment('蝦皮幣抵扣');
            ...
            $table->unsignedInteger('installment_months')->nullable()->comment('分期付款月數');
            $table->string('city')->nullable()->comment('城市');
            $table->string('district')->nullable()->comment('行政區');
            $table->tinyInteger('shipping_option')->nullable()->comment('運送方式');
            ...
            $table->json('note')->nullable()->comment('訂單備註');
