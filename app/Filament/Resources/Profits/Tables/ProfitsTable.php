    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('shopee_deduction_amount')->sortable()->label('蝦皮折抵金額'),
                TextColumn::make('shop_discount_amount')->sortable()->label('賣場折扣金額'),
                TextColumn::make('shop_shopee_coin_return_amount')->sortable()->label('賣場蝦幣回饋金額'),
                TextColumn::make('shopee_discount_amount')->sortable()->label('蝦皮折扣金額'),
